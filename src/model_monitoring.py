# ==============================================
# src/model_monitoring.py - Detección de Data Drift
# ==============================================
...
# 1. TRUCO DE RUTAS: Para que encuentre src desde la raíz del proyecto
ROOT_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
if ROOT_DIR not in sys.path:
    sys.path.append(ROOT_DIR)

# Importación segura desde el paquete src
...
if __name__ == "__main__":
    ...
    # 1. Cargamos datos y preprocesador
    X_train, X_test, y_train, y_test, preprocessor = make_train_test_data()
    
    # 2. IMPORTANTE: Aplicar el preprocesador antes de medir el Drift
    # Transformamos Train y Test para que el Drift se mida sobre los datos limpios y escalados
    ...
    # 3. Generar Reporte
    df_report = detect_drift(X_train_transformed, X_test_transformed)
